...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(REGISTER_URL, JSON.stringify({ user, pwd, matchPwd,email }), {
    ...
    <>
      {loading ? ( 
        ...
        <section>
          ...
          <div
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] bg-no-repeat bg-blue-900 rounded-[65px]"
              ...
              >
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-72 h-12 px-4 mb-8 rounded pr-10"
                    onChange={(e) => {
