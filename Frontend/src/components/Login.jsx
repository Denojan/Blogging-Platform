...
toast.success("Login successfully");
            ...
            if (roles.includes(5000)) {
                navigate("/admin/allBlog", { replace: true }); 
            } else if (roles.includes(2000)) {
                navigate("/user/allBlog", { replace: true }); 
            } 
        } catch (err) {
            if (!err?.response) {
        ...
        {loading ? ( 
          ...
          <section>
            <div className="flex items-center justify-center h-screen  ">
              ...
              <div
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-no-repeat bg-blue-900 rounded-[65px]"
